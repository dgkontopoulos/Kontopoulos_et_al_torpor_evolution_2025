...
# 737 mammals, accounting for phylogeny.
#
...
#
# Rscript fit_MCMCglmm_without_body_mass_corrections_only_across_mammals.R 1
# Rscript fit_MCMCglmm_without_body_mass_corrections_only_across_mammals.R 2
# Rscript fit_MCMCglmm_without_body_mass_corrections_only_across_mammals.R 3
# Rscript fit_MCMCglmm_without_body_mass_corrections_only_across_mammals.R 4
# Rscript fit_MCMCglmm_without_body_mass_corrections_only_across_mammals.R 5
#
...
# it will produce an .Rda file per chain, in the ../Results/MCMCglmm_fits_mammals/ 
# directory.
#
...
# file.
Sys.sleep(10)
dir.create('../Results/MCMCglmm_fits_mammals/', showWarnings = FALSE)
save(fit, file = paste('../Results/MCMCglmm_fits_mammals/', chain_id, '.Rda', sep = ''))
